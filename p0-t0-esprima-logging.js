...
function addLogging(code) {
    const ast = espree.parse(code); //Convierte code en un elemento procesable en tiempo de ejecución (en lugar de string y lo guarda en ast)
